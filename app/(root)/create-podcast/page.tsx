...
const CreatePodCast = () => {
  ...
  return (
    <section className="mt-10 flex flex-col">
      <h1 className='text-20 font-bolg text-white-1'>Create Podcast</h1>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="mt-12 flex w-full flex-col">
          <div className="flex flex-col gap-[30px] border-b border-black-5 pb-10">
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col gap-2.5">
                  <FormLabel className="text-16 form-bold text-white-1">Username</FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col gap-2.5">
                  <FormLabel className="text-16 form-bold text-white-1">Description</FormLabel>
                  <FormControl>
